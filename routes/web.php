...
Route::get('/billView', 'SaleController@bill_view');
Route::get('/printBikeBill/{id}', 'SaleController@printBikeBill');
...
Route::resource('ledgerview','LedgerviewController');


Route::resource('staffledger','StaffledgerController');
Route::post('saveledger', 'StaffledgerController@saveledger');
...
Route::post('importExcelService', 'ServiceController@saveservices');
