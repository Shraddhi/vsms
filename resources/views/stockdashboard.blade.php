                ...
                <div id="page-wrapper">
                  <div class=" panel left-panel cf col-md-3" style="height:100%;margin: 0px; left: 0%; top: 21%; position: fixed;">
                      ...
                      <div class="title" style="position:fixed;width: 300px;">
                       <pre style="background:#09649a !important; color:white">Notifications </pre>
                       </div>
...
<table >
        <tr >
          ...
          <th style="border: 0 !important" >Date:</th>
              <td style="border: 0 !important"><span id="">{{  date("Y-m-d")}} </span></td><br/>

          </tr>
          <tr>
          <th style="border: 0 !important">Customer Name:</th>
          <td style="border: 0 !important"><input type="text" id="customer_name" name="customername" required/></td>

          <th style="border: 0 !important">Street Name:</th>
          <td style="border: 0 !important"><input type="text" id="street_name" name="street_name" required/></td>

          <th style="border: 0 !important">Location</th>
          <td style="border: 0 !important"><input type="text" id="location" name="customeraddress" required/></td>


        </tr>
    <tr>
    <th style="border: 0 !important">Phone:</th>
          <td style="border: 0 !important"><input type="number" id="phone" name="customerphone" required/></td>
...
<table class="" id="items">
    ...
    <tbody class="body" >
        ...
        <td colspan="2" class="total-line" style="text-align:left;height: 40px;" > Subtotal Rs. <b class="stotal" >0</b> </td>
        </tr>
<!--
        <tr>
        <td colspan="3" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left;height: 40px;"> Discount % <input type="number" class="distot" id="distot" class="getmoney form-control" style=" width: 60% !important;
...
<!--
        <tr>
        <td colspan="3" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left;height: 40px;"> Total Rs.  <b class="total" >0</b> </td>
        </tr>
-->
        <tr>
        <td colspan="3" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left; "> Amount Paid  Rs.<input type="text" name="debit" class="getmoney form-control" style=" width: 60% !important;
    height:40px !important; display:inline-block;"/></td>
        </tr>
        <tr>
        <td colspan="3" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left; "> Due Amount  Rs. <input type="text" class="backmoney form-control" style=" width: 60% !important;
    height:40px !important; display:inline-block;" /> </td>
        </tr>
    </tbody>
    <tfoot>

        <th colspan="5"><input type="submit" value="Sell Bike " name="save" class="btn btn-primary" />
...
@else
 <h4 align="center" style="color:#DCD9D8"> No More Bike in inventory  </h4> <a style="float:right" href="inventory"> Add Bike </a>
@endif
...
//        $('.body1').delegate('.qty1','change',function(){
//            var i = $(this).attr('id');
//          
//           
//             $("#" + i).attr({
...
//      $('.body1').delegate('.qty1').on('input', function() {
//          
//          var i = $(this).attr('id');
//            
//             $("#" + i).attr({
    ...
    $(function(){
        ...
        $('.getmoney1').change(function(){
           var total1=$('.total1').html();
            ...
            var t1=total1-getmoney1;
            $('.backmon').val(t1).toFixed(2);
        });
       $('.totaldis1').change(function(){
...
//           alert(finaltotal);
    ...
    '<td><select name="product_id1[]" class="form-control product_id1" style="height: 40px;">'+product1+'</select></td>'+
            '<td><input type="text" name="price1[]" class="price1 form-contol"></td>'+
               '<td><input type="number" name="qty1[]" id="quantityparts' + n1 + '" class="qty1 form-contol"></td>'+
        ...
        $('.body1').delegate('.delete1','click',function(){
         ...
         $('.body1').delegate('.product_id1','change',function(){
            var tr1= $(this).parent().parent();
             ...
             var qty12 = tr1.find('.product_id1 option:selected').attr('data-qty1');
//             alert("maximum items avialable:"+ qty12);
              tr1.find('.qty1').val(1);
             
             
//             delegate('.qty1','change',function(){
//            var i = $(this).attr('id');
//          
//           
//             $("#" + i).attr({
//                  "max" : qty12,        // substitute your own
//                  "min" : 1          // values (or variables) here
//                });
//            
//             $("#" + i).change(function (e) {
...
//         });
             ...
             //limiting the maximum number of parts avialable
              $("#quantityparts").attr({
                  "max" : qty12,        // substitute your own
                  "min" : 1          // values (or variables) here
                });
...
//              $("#quantityparts").change(function (e) {
//                if ( $('#quantityparts').val() > qty12) {
//                    $('#quantityparts').val('');
//                    return;
//                } 
//            });
...
<table >
        <tr >
          ...
          <tr>
          <th style="border: 0 !important">Customer Name:</th>
          <td style="border: 0 !important"><input type="text" id="customer_name" name="customername1"  required/></td>

          <th style="border: 0 !important">Street Name:</th>
          <td style="border: 0 !important"><input type="text" id="street_name" name="street_name" required/></td>

          <th style="border: 0 !important">Location</th>
          <td style="border: 0 !important"><input type="text" id="location" name="customeraddress1" required/></td>
    </tr>
    <tr>
          <th style="border: 0 !important">Phone:</th>
          <td style="border: 0 !important"><input type="number" id="phone" name="customerphone1" required/></td>
    ...
    <tbody class="body1" >
        ...
        <th class="no1">1</th>
            ...
            <select name="product_id1[]" class="form-control product_id1" style="height: 40px;">
                ...
                <option data-price1="{{ $r1->price }}" data-qty1="{{ $r1->units }}" value="{{  $r1->id }}">
        ...
        <input type="text" name="price1[]" class="price1 form-contol">
            ...
            <td>
        <input type="number" name="qty1[]"  id="quantityparts" class="qty1 form-contol" >
        </td>
            <td>
...
-->
        ...
        <td colspan="2" class="total-line" style="text-align:left;height: 40px;" > Subtotal Rs. <b class="subtotal" >0</b> </td>
        </tr>
        <tr>
        <td colspan="4" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left;height: 40px;"> Discount. <input type="text" name="totaldis1" class="totaldis1 form-control" style=" width: 60% !important;
    height:40px !important; display:inline-block;"/></td>
        </tr>
        <tr>
        <td colspan="4" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left;height: 40px;"> Total Rs.  <input type="number" class="total1" style="display:inline-block;"/> </td>
        </tr>
        <tr>
        <td colspan="4" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left; "> Amount Paid  Rs.<input type="text" name="debit1" class="getmoney1 form-control" style=" width: 60% !important;
    height:40px !important; display:inline-block;"/></td>
        </tr>
        <tr>
        <td colspan="4" class="blank" ></td>
        <td colspan="2" class="total-line" style="text-align:left; "> Due Amount  Rs. <input type="text" class="backmon form-control" style=" width: 60% !important;
    height:40px !important; display:inline-block;" /> </td>
        </tr>


        <th colspan="6"><input type="submit" value="Sell Parts " name="save" class="btn btn-primary" />
             <!-- <input type="submit" value="Print & Save" onclick="printval('printablearea')"  name="save" class="btn btn-success" style="float: right;" /> -->

        </th>
    </tfoot>
</table>
@else
 <h4 align="center" style="color:#DCD9D8"> No More Parts in Inventory  </h4> <a style="float:right" href="inventory"> Add Parts </a>
@endif
