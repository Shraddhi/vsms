...
<iframe style="margin-top: 2%;" scrolling="no" border="0" frameborder="0" marginwidth="0" marginheight="0" allowtransparency="true" src="http://rajanmaharjan.com.np/getdate/index.php?dateType=np" height="30"></iframe></span>
 ...
 <div class="col-md-12" style="    width: 80%;
    ...
    color: #fff;
    font-size: 30px;
    padding: 0px 0px 20px 0px;">Edit Bike Details</h2>
 <!--modal-->
  {!! Form::model($editid, ['method' => 'PATCH','route' => ['inventorybikeupdate.update', $editid->id]]) !!}
                                <fieldset>
                                    <div class="input-group">

                                        <span class="input-group-addon"><i class="fa fa-first-order">&nbsp;Model Name</i></span>
                                        <input type="text" name="model_name" class="form-control" value="{{$editid->model}}" required />
...
-->
                ...
                <input type="text" class="form-control" placeholder="Engine Number" name="engine" value="{{$editid->model}}" required >
              </div><br/>
                                     <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-list">&nbsp;Chasis Number</i></span>
                <input type="text" class="form-control" placeholder="Chasis Number" name="chasis" value="{{$editid->chasis_number}}" required ><br/>
              </div><br/>
                                     <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-money">&nbsp;Quantity</i></span>
                <input type="number" class="form-control" placeholder="Quantity" name="quantity" value="{{$editid->units}}" required ><br/>
              </div><br/>
                                    <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-money">&nbsp;Reg_no</i></span>
                <input type="text" class="form-control" placeholder="Registration Number" name="reg_no" value="{{$editid->reg_no}}" required ><br/>
              </div><br/>
                                     <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-picture-o">&nbsp;Purchase Price in NRS</i></span>
                 <input type="number" class="form-control" placeholder="Unit Price" name="purchaseprice" value="{{$editid->purchaseprice}}" required ><br/>
              </div><br/>
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-picture-o">&nbsp;Unit Price in NRS</i></span>
                 <input type="number" class="form-control" placeholder="Unit Price" name="unitprice" value="{{$editid->price}}" required ><br/>
              </div><br/>
            <div class="input-group">
            ...
            <input type="hidden" name="bikeeditid" value="{{$editid->id}}"/>
