...
-->
                ...
                <span class="input-group-addon"><i class="fa fa-picture-o">&nbsp;Purchase Price in NRS</i></span>
                 <input type="number" class="form-control" placeholder="Unit Price" name="purchaseprice" required ><br/>
              </div><br/>
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-picture-o">&nbsp;Unit Price in NRS</i></span>
                 <input type="number" class="form-control" placeholder="Unit Price" name="unitprice" required ><br/>
              </div><br/>
                                      <div class="input-group">
              ...
              <table id="example1" class="display compact table-bordered table-striped" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <td><div class="col-sm-2">
                      <a  href="{{route('inventorybikeupdate.edit',$c->id)}}"><button class="btn btn-info btn-xs">Edit</button></a>
                    </div>
                    <div class="col-sm-2">
                ...
                <tbody>
                    ...
                    <td>{{$c1->created_at}}</td>
                        ...
                        <td> <div class="col-sm-3">
                            <a  href="{{route('inventorybikepartupdate.edit',$c1->id)}}"><button class="btn btn-info btn-xs">Edit</button></a>
                          </div>
                          <div class="col-sm-2">
                        <a>
