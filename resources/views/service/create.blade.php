    ...
    <tbody class="body">
        ...
        <td>
           <select class="form-control servicetype" name="servicetype[]">
            ...
            <td>
        <input type="number" name="timedays[]" class="timedays form-contol" style="width:90px;">
        </td>
            <td>
        <input type="number" name="cost[]" class="cost form-contol" style="width:110px;">
        </td>
            <td>
...
<input type="submit" value="Save Servicing" name="save" class="btn btn-success"/>
</form>
