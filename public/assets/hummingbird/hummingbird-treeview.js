(function($){
	...
	if (methodName == "expandAll") {
	    ...
	    return this.each(function(){$.fn.hummingbird.expandAll($(this),options.collapsedSymbol,options.expandedSymbol);
	...
	tree.find('input:checkbox').on('click', function(e) {
		...
		if (doubleMode == false) {
	    		...
	    		if ( L > 1) {
	    		    ...
	    		    //-> trigger clickvar Zvar = allVariables[$(this).attr("data-id")];
